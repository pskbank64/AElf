...
namespace AElf.Execution
{
    public class ParallelTransactionExecutingService : IExecutingService
    {
        ...
        public ParallelTransactionExecutingService(IActorEnvironment actorEnvironment, IGrouper grouper,ServicePack servicePack)
        {
            ...
            _grouper = grouper;
            _singlExecutingService = new SimpleExecutingService(servicePack.SmartContractService, servicePack.TransactionTraceStore, servicePack.StateStore, servicePack.ChainContextService);
        }
